                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: 'Ваше ім\'я та прізвище',
                                ...
                                (records) => _model.simpleSearchResults =
                                  ...
                                  records
                                      ...
                                      .toList(),
                                        ...
                                        .search(_model.phoneTextController.text)
                                        .map((r) => r.object)
                                        .toList(),
                              )
                              .onError(
                          ...
                          if (_model.simpleSearchResults.isNotEmpty) {
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('Помилка'),
                                  content: Text('Телефон вже використовуєтся'),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                ...
                var confirmDialogResponse = await showDialog<bool>(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Ваш аккаунт буде видалено без можливості його повернути'),
                          actions: [
                            TextButton(
                              onPressed: () =>
