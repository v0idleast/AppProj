...
class ContactInfoWidget extends StatefulWidget {
  ...
  static String routePath = '/contactInfo';
                                      ...
                                      TextSpan(
                                        ...
                                        recognizer: TapGestureRecognizer()
                                          ..onTap = () async {
                                            await launchUrl(Uri(
                                              scheme: 'tel',
                                              path: '+380 67 822 3556',
                                            ));
                                          },
                                      ),
                                      TextSpan(
                                        text: '+380 73 822 3556',
                                        style: TextStyle(
                                          fontWeight: FontWeight.w300,
                                        ),
                                        mouseCursor: SystemMouseCursors.click,
                                      ...
                                      TextSpan(
                                        ...
                                        recognizer: TapGestureRecognizer()
                                          ..onTap = () async {
                                            await launchUrl(Uri(
                                              scheme: 'mailto',
                                              path: ' melnyks123@gmail.com',
                                            ));
                                          },
                                      ),
                                      TextSpan(
                                        text: 'vl.yampol@gmail.com',
                                        style: TextStyle(
                                          fontWeight: FontWeight.normal,
                                          fontSize: 20.0,
                                        ),
