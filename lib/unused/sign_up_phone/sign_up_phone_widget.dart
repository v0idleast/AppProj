...
import 'sign_up_phone_model.dart';
export 'sign_up_phone_model.dart';

class SignUpPhoneWidget extends StatefulWidget {
  const SignUpPhoneWidget({super.key});

  static String routeName = 'SignUpPhone';
  static String routePath = '/signUpPhone';
...
class _SignUpPhoneWidgetState extends State<SignUpPhoneWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.phoneTextController?.text = '+380';
        }));
  }
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 24.0),
                              child: Text(
                                'Давайте розпочнемо з заповнення форми знизу.',
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      font: GoogleFonts.roboto(
                                      ...
                                      onPressed: () async {
                                        ...
                                        await authManager.beginPhoneAuth(
                                          ...
                                          onCodeSent: (context) async {
                                            context.goNamedAuth(
                                              LoginVerifyCodeWidget.routeName,
                                              context.mounted,
                                              ignoreRedirect: true,
                                            );
                                          },
