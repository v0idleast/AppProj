...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xB139ADEF);
  ...
  late Color lineColor = const Color(0x00000000);
  late Color popupBack = const Color(0x84FFFFFF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryBackground = const Color(0xFF0C0A27);
  late Color secondaryBackground = const Color(0xFF08061A);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
  ...
  late Color lineColor = const Color(0xFF9AFCBD);
  late Color popupBack = const Color(0xFF0C0A27);
  late Color primaryBtnText = const Color(0xFFFFFFFF);
  late Color backgroundComponents = const Color(0xFF1D2428);
}
